...
#lmen doit Ãªtre fourni et filtrÃ© par bdtopo
...
com_frontalieres <- Part_frontalier %>% 
      filter(part_frontalier >= seuil_nb_hab)
...
# # #RÃ©cupÃ©rer les contours des communes rurales  pour les voir sur QGIS:
...
# #Récupérer le revenu médian des ménages frontaliers / non_frontaliers
deb <- Sys.time()
...
#### ***********************************************************************
####    PrÃ©paration des couches carroyÃ©es pour cartographie (lissage)  =====
#### ***********************************************************************

#' CrÃÂ©ation des couches carroyÃÂ©es en input de l'application de cartogrpahie
#' Pour chaque version (annee-ville-taille des carreaux) :
#' - On crÃÂ©ÃÂ© une variable de contribution du carreau ÃÂ  la sÃÂ©grÃÂ©gation totale
#' - On lisse la sÃÂ©grÃÂ©gation et la contribution des carreaux (en lissant prÃÂ©alablement les populations des diffÃÂ©rents groupes sociaux et en recalculant proprement les indicateurs sur les populations lissÃÂ©es)
#' - On discrÃÂ©tise les carreaux par niveaux de revenus et on associe une couleur pour la carto
#' - Sauvegarde
